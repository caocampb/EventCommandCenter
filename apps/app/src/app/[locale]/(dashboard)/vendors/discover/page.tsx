  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-6" style={{ backgroundColor: colors.background.page }}>
      ...
      <header className="space-y-1 mb-6">
        ...
        <h1 className="text-2xl font-semibold" style={{ color: colors.text.primary }}>Discover Vendors</h1>
      </header>
      ...
      {hasSearched ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          <svg width="64" height="64" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mb-4 text-gray-600">
          ...
          <h3 className="text-xl font-medium text-white mb-2">Ready to discover vendors</h3>
