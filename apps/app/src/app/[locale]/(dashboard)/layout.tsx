...
export default async function DashboardLayout({ children, params }: DashboardLayoutProps) {
  // Get server-side authentication state with error handling
  try {
    ...
    console.error("Exception in dashboard layout:", err);
    
    // In case of unhandled exceptions, redirect to login safely
    return redirect(`/${params.locale || 'en'}/login?error=layout-error`);
  }
}
