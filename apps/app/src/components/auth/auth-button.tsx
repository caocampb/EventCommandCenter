  ...
  if (isAuthenticated) {
    return (
      <button
        ...
        className="flex items-center rounded-md px-3 py-2 text-sm text-gray-600 hover:text-black dark:text-gray-400 dark:hover:text-white transition-colors duration-120"
      >
