...
export const updateSession = async (
  ...
  console.log("Middleware: Supabase Anon Key available:", !!process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY);
  ...
  try {
    ...
    try {
      ...
      // Return response without user to allow the middleware to continue
